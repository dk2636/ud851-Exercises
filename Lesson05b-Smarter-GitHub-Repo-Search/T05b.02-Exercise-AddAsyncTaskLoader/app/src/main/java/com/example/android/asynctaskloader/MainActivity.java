    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                String searchQueryUrlSting = args.getString(SEARCH_QUERY_URL_EXTRA);
                // TODO (11) If the URL is null or empty, return null
                if (searchQueryUrlSting == null || TextUtils.isEmpty(searchQueryUrlSting)) {
                    return null;
                }
                // TODO (12) Copy the try / catch block from the AsyncTask's doInBackground method
                // END - loadInBackground
                try {
                    URL githubURL = new URL(searchQueryUrlSting);
